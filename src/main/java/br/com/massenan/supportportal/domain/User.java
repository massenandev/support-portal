package br.com.massenan.supportportal.domain;
...
public class User implements Serializable {
    ...
    private String[] roles; // role_user, role_admin... roles holds authorities
    private String[] authorities; // to delete, read, create or update
